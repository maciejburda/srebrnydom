...
<FactCard
  eyebrow="Karta artysty"
  title="Jan Kosno (1913–1996)"
  items={[
    { label: 'Urodzony', value: '14 czerwca 1913 r., rodzina górnicza' },
    { label: 'Wykształcenie', value: 'Akademia Sztuk Pięknych w Krakowie, dyplom 1955 (pracownie W. Jarockiego i Z. Pronaszki)' },
    { label: 'Członkostwo', value: 'Związek Polskich Artystów Plastyków od 1956 r.' },
    { label: 'Pobyt twórczy', value: 'Paryż 1968–1971 – stypendium Ministerstwa Kultury i Sztuki' },
    { label: 'Nagrody', value: 'Brązowy medal „Prix Lutetia”, Galérie de Sèvres, Paryż 1971' },
    { label: 'Zbiory', value: 'Muzeum w Katowicach, Ministerstwo Kultury oraz kolekcje prywatne w Polsce, Francji, USA i Japonii' },
  ]}
/>

[Srebrny Dom](/o-nas/) został uświetniony obrazami wybitnego malarza Jana Kosno. W korytarzach oraz pokojach pensjonariuszy można znaleźć owoce jego twórczości. Każdemu z pensjonariuszy przysługuje możliwość wyboru obrazu, który zostanie zawieszony w jego pokoju. Dodatkowo w przypadku większego zainteresowania twórczością Jana Kosno istnieje możliwość zakupu poszczególnych dzieł z dodatkowym rabatem dla pensjonariuszy.
...
Po latach wznowiono sprzedaż obrazów. Pierwszy z nich sprzedał się w Sopockim Domu Aukcyjnym w 2021 roku.

<CtaCard
  eyebrow="Twórczość Jana Kosno"
  title="Zobacz pełną kolekcję obrazów"
  sub="Pensjonariusze Srebrnego Domu mogą wybrać obraz do swojego pokoju, a w razie zainteresowania – kupić wybrane dzieła z dodatkowym rabatem."
  primaryLabel="Zobacz galerię"
  primaryHref="https://www.dropbox.com/sh/khjy701309n5c17/AABGZZK1e6m_NYNO_W4-Km2ba?dl=0"

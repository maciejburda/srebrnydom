...
import PillRow from '../../../src/components/PillRow'
import Quote from '../../../src/components/Quote'
import CtaCard from '../../../src/components/CtaCard'

<PillRow
  eyebrow="Filary metody"
  items={[
    'Godność',
    'Samodzielność',
    'Indywidualny plan',
...
<Quote author="Maria Montessori" meta="1870–1952">
...
<CtaCard
  eyebrow="Sprawdź, jak działa to u nas"
  title="Zobacz Montessori w codziennej opiece"
  sub="W naszej ofercie i cenniku pokazujemy, jak filozofia Marii Montessori przekłada się na konkretne zajęcia, wsparcie i komfort pobytu."
  primaryLabel="Sprawdź ofertę"
  primaryHref="/oferta/"
  secondaryLabel="Cennik domu seniora"
